...
import (
	...
	"github.com/CaioVGA/chat-service-chatgpt/chat-service/domain/entity"
	"github.com/CaioVGA/chat-service-chatgpt/chat-service/domain/gateway"
...
func (uc *ChatCompletionUseCase) Execute(ctx context.Context, input ChatCompletionInputDTO) (*ChatCompletionOutputDTO, error) {
	...
	//adding all messages to OpenAI structure
